...
feature 'Engineer Authentication Required for Engineer-Only Functions', %q{
  ...
  As an engineer
  I want to be required to authenticate to access engineer-specific actions.
} do
  
  scenario "A user is required to authenticate before accessing an engineer-specific function" do
